...
调用：
    ...
    report = asyncio.run(
        EvalRunner().run(DATASET, dataset_name="golden_aftersale")
    )

或直接跑：
    uv run python script/run_eval.py
"""
...
DATASET: list[EvalQuery] = [
    ...
    EvalQuery(
        ...
        relevant_source_patterns=["7天无理由", "退货", "运费险"],
    ...
    EvalQuery(
        ...
        user_id=_AFTERSALE_USER,
        expected_scene="aftersale",
        relevant_source_patterns=["退款", "进度", "到账"],
    ...
    EvalQuery(
        ...
        user_id=_AFTERSALE_USER,
        expected_scene="aftersale",
        relevant_source_patterns=["换货", "15天换货"],
    ...
    EvalQuery(
        ...
        user_id=_AFTERSALE_USER,
        expected_scene="aftersale",
        relevant_source_patterns=["手机故障", "人为"],
    ...
    EvalQuery(
        ...
        user_id=_AFTERSALE_USER,
        expected_scene="aftersale",
        relevant_source_patterns=["退货", "换货"],
    ...
    EvalQuery(
        ...
        user_id=_AFTERSALE_USER,
        expected_scene="aftersale",
        relevant_source_patterns=["退款", "退货"],
